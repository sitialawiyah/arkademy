...
<body>
	...
	<section id="box-profile">
        ...
        <div class="photo" style="background-image: url(img/nazar.jpg);"></div>
    </div>
    <div class="description">
        <h1  id="pName">Pacar Alaw</h1>
        <p id="pRole">Law? lawkana bayyinanal habib</p>
		...
		<div class="data">
			<p class="field">Age</p>
			<p id="pAge" class="text-gray">16</p>
		</div>
		<div class="data">
			<p class="field">Location</p>
			<p id="pLocation" class="text-gray">Bogor, Indonesia</p>
		</div>
		<div class="data">
		...
		<div class="data">
			...
			<p id="pEmail" class="text-gray">sitialawiyah666@gmail.com</p>
		</div>
	</div>
	</section>
...
<!-- </form> -->
	...
	function simpanForm(){
		...
		document.getElementById("pAvalable").innerHTML = available;
